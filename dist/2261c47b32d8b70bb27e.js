...
$jscomp.polyfillIsolated = function (h, n, k, p) {
  ...
  null != n && (h ? $jscomp.defineProperty($jscomp.polyfills, l, {
    ...
    writable: !0,
    value: n
  }) : n !== k && (void 0 === $jscomp.propertyToPolyfillSymbol[l] && (k = 1E9 * Math.random() >>> 0, $jscomp.propertyToPolyfillSymbol[l] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(l) : $jscomp.POLYFILL_PREFIX + k + "$" + l), $jscomp.defineProperty(p, $jscomp.propertyToPolyfillSymbol[l], {
    configurable: !0,
    writable: !0,
    value: n
  })));
...
$jscomp.polyfill("Array.prototype.copyWithin", function (h) {
  ...
  return h ? h : function (k, p, l) {
    ...
    if (k < p) for (; p < l;) p in this ? this[k++] = this[p++] : (delete this[k++], p++);else for (l = Math.min(l, y + p - k), k += l - p; l > p;) --l in this ? this[--k] = this[l] : delete this[--k];
    return this;
  };
}, "es6", "es3");
