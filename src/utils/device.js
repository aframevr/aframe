let error = require('debug')('device:error');

let vrDisplay;
let supportsVRSession = false;
let supportsARSession = false;
 ...
 */
let isWebXRAvailable = module.exports.isWebXRAvailable = !window.debug && navigator.xr !== undefined;
...
if (isWebXRAvailable) {
  let updateEnterInterfaces = function () {
...
function isTablet (mockUserAgent) {
  let userAgent = mockUserAgent || window.navigator.userAgent;
