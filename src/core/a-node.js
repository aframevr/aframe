...
module.exports = registerElement('a-node', {prototype: proto});

class ANodeV1 extends HTMLElement {
  constructor () {
    super();
    this.computedMixinStr = '';
    this.hasLoaded = false;
  ...
  */
  ...
  updateMixins (newMixins, oldMixins) {
    var newMixinIdArray = ANodeV1.newMixinIdArray;
    var oldMixinIdArray = ANodeV1.oldMixinIdArray;
    var mixinIds = ANodeV1.mixinIds;
...
ANodeV1.evtData = {};
ANodeV1.newMixinIdArray = [];
ANodeV1.oldMixinIdArray = [];
ANodeV1.mixinIds = {};
window.ANodeV1 = ANodeV1;
customElements.define('a-node-v1', ANodeV1);
