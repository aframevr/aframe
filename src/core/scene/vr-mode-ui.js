 ...
 */
var VRModeUI = module.exports.VRModeUI = function (sceneEl) {
  var self = this;
...
VRModeUI.prototype = {
  update: function () {
    ...
    var disabled = sceneEl.getAttribute('vr-mode-ui') === 'false';

    if (disabled || this.insideLoader || utils.getUrlParameter('ui') === 'false') {
      return this.remove();
    }
