(function($) {
  ...
  */
  ...
  function updateAnchors (currentId, previousId) {
  ...
  $document.on('flatdoc:ready', function () {
    $('h2, h3').scrollagent(updateAnchors);
  });
  ...
  */
  ...
  $document.on('flatdoc:ready', function () {
    ...
    $document.on('click', '.menu a[href^="#"]', function () {
      clickedId = this.getAttribute('href').substr(1);
    });
    $document.on('anchor', function () {
      updateAnchors(clickedId);
    });
  });
...
// Example:
//
//      $("h2").scrollagent(function (currentId, previousId, currentElement, previousElement) {
//        if (previousId) {
//          $("[href='#"+previousId+"']").removeClass('active');
//        }
//        if (currentId) {
//          $("[href='#"+currentId+"']").addClass('active');
//        }
