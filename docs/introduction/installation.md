...
<a id="builds-prod" class="btn btn-download" href="https://aframe.io/releases/0.9.1/aframe.min.js" download>Production Version <span>0.9.1</span></a> <em class="install-note">Minified</em>
<a id="builds-dev" class="btn btn-download" href="https://aframe.io/releases/0.9.1/aframe.js" download>Development Version <span>0.9.1</span></a> <em class="install-note">Uncompressed with Source Maps</em>
