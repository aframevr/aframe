...
| material        | For material assets. Resolves an ID selector to a `<a-material>` element (e.g., `#gold`) to the underlying shared `THREE.Material` instance. Also accepts a `THREE.Material` instance directly.                                                                                                                                                                  | null                     |
