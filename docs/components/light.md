...
Where they differ though is that they will color each angle differently based upon a spherical harmonic. This spherical harmonic is generated by analyzing a [cubemap][cubemap]. The cubemap you provide doesn't need to be high resolution since it's only used to generate the spherical harmonics.
